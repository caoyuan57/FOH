...
% places_zs 用于加载和准备 CNN 特征，进行零样本学习任务
% 输入：
...
% T 设置为 20，表示从每个 unseen 类别中选择 20 个样本进行测试
T = 20;
...
logInfo('[Places205_CNN_Zero_Shot] loaded in %.2f secs', toc);  % 输出加载时间
end
